...
*/
  ...
  return (
    <div className='containeradd'>
      ...
      <Col>
      <div >
  <div className="AddMerchantmainnew"><h3 className="AddMerchantHeading">Merchant Signup</h3><br />
    ...
    <Form onSubmit={postData} id="myForm" style={{ backgroundColor: ''}} >
      ...
      <Form.Row>
        <input type='checkbox' id='terms' /><span>&nbsp;&nbsp;</span>Accept<a className='term' onClick={()=>{
          alert('click')
          setTermsActive(true)}}><span>&nbsp;</span>Terms and Conditions</a> 
      </Form.Row>
      <br />
      <Form.Row>
  ...
  {
      termsActive==true?<TermsModal
      onNoClick={()=>{setTermsActive(false)}} />:null
    }
  </div>)
