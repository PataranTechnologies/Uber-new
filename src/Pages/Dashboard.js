  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <List>
          <ListItem button className="AddMerchantText" onClick={(e) =>  props.history.push("/AddNewMerchant")}>
      ...
      <div className={fragment==="HOME_FRAGMENT"?'selected':'hover'}>
          ...
          <ListItem button onClick={(e) => props.history.push("/AllMerchantsFragment")}>
            <ListItemIcon>
              <PersonIcon />
            </ListItemIcon>
          ...
          <ListItem button onClick={(e) => props.history.push("/AllMembersFragment")}>
            <ListItemIcon>
              <GroupIcon />
            </ListItemIcon>
          ...
          <ListItem button onClick={(e) => props.history.push("/ResetPassword")}>
            <ListItemIcon>
              <LockIcon />
            </ListItemIcon>
